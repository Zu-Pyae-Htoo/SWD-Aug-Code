...
//   }
//   y() {
//     console.log("y worked");
//     return this;
//   }
//   z() {
//     console.log("z worked");
//     return this;
//   }
// }
// //this = current obj
...
//run.x()=>return obj.y()=> return obj.z()

//အသီးတွေထဲက စကားလုံး ၅လုံးပါတဲ့အသီးတွေကို upper case ပြောင်းပြီး console မှာ list ထုတ်ပြပါ
...
//price 50အောက်ကို ရှာပြီး ၅ကျပ်ထပ်ပေါင်း ၊ စုစုပေါင်းကိုရှာပါ
...
//Pseudo code for destructure in Obj
// ==================================
...
//Pseudo code for destructure in Array
// ==================================
...
// console.table(
//   product.map(({image,title,price,rating:{rate}})=>{
//     return{
//       image,
//       title,
//       price,
