...
//   return pointTotal;
// }
// console.log(calPoint(points));
// console.log(calPoint([1,2,3]));

// ===========================================================
// 3. စုံသီးသန့်၊ မသီးသန့် ခွဲပေးနိုင်တဲ့ function

// console.log( oddNum =5%4?  "odd":"even");
// console.log(evenNum = 8%4? "odd":"even");

// const separateOdd = function (numArray) {
//   let result = [];
//   let resultIndex = 0;
...
// const separateEven = function(numArray){
//     let result =[];
//     let resultIndex =0;
//     for(let x of numArray){
//         if(x%2 === 0){
...
// const separate = function (numArray) {
//   let oddNum = [];
//   let oddIndex = 0;
//   let evenNum = [];
//   let evenIndex = [];
...
// console.log(separate([1,2,3,4,5,6,7,8,9]));
