...
const Record = () => {
  return (
    <tr className="group odd:bg-white  even:bg-gray-100 " product-id={3}>
      ...
      <td className="px-6 py-4 text-end record-price">200</td>
      <td className="px-6 py-4 text-end">
        ...
        <span className="record-q w-5 inline-block">3</span>
      ...
      <td className="px-6 py-4 text-end relative">
        <span className="record-cost">600</span>
